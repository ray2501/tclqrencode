...
PKG_SOURCES	=  generic/tqrencode.c generic/tclqrencode.c generic/bitstream.c generic/mask.c generic/mmask.c generic/mqrspec.c generic/qrencode.c generic/qrspec.c generic/qrinput.c generic/rsecc.c generic/split.c
PKG_OBJECTS	=  tqrencode.o tclqrencode.o bitstream.o mask.o mmask.o mqrspec.o qrencode.o qrspec.o qrinput.o rsecc.o split.o
...
PKG_LIB_FILE	= libtclqrencode1.2.so
PKG_LIB_FILE8	= libtclqrencode1.2.so
PKG_LIB_FILE9	= libtcl9tclqrencode1.2.so
PKG_STUB_LIB_FILE = libtclqrencodestub1.2.a
...
top_builddir	= /home/danilo/Public/tclqrencode
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"tclqrencode\" -DPACKAGE_TARNAME=\"tclqrencode\" -DPACKAGE_VERSION=\"1.2\" -DPACKAGE_STRING=\"tclqrencode\ 1.2\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_tclqrencode=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"tclqrencode\" -DPACKAGE_TARNAME=\"tclqrencode\" -DPACKAGE_VERSION=\"1.2\" -DPACKAGE_STRING=\"tclqrencode\ 1.2\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_tclqrencode=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
